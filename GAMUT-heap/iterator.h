...
MMLT_DEVICE
bool lessThan(Type target, Type num)
{
	return target < num;
}
class OutIterator {
private:
  using TileC = TileStoreUnlinear<Type, heap_algo, lessThan, heap_size, Count_Thr_Block_Tot>;
  TileC tile_c;
...
public:
  ...
  OutIterator(Array<Type, Size_Thr_Tot> &out_reg, Array<Type, Size_Thr_Row> *regs_row,
      ...
      : tile_c(smem.smem_c, (Type *)param.work, (int *)param.inputs[3], (int *)param.inputs[2]),
