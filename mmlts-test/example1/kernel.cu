...
__global__
__launch_bounds__(example1::Count_Thr_Block_Tot)
void example1::compute
(
	Params param
)
{
	...
	OutIterator out_iter(out_reg, in_regs_row, in_regs_col, in_regs_tot, smem->out_smem, param, id);
	MMLT_UNROLL
	for (int i = 0; i < Size_Thr_Row; i++) {
...
__global__
__launch_bounds__(example1::Reduce_Row * example1::Reduce_Col)
void example1::reduce
(
	Params param
)
{
